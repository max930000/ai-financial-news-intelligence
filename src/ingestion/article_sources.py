"""
Sources the article fetcher is allowed to read.

Only sites listed here can be fetched. Each entry says where the body lives in
that site's HTML. Add a source only after checking its terms of use and
robots.txt, and after testing extraction on real articles.
"""
